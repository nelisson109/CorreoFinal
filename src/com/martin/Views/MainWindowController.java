    ...
    public void imprimirEmail(ActionEvent event) {//informe para un email
        ...
        if (correo != null) {
            try {
                ...
                JasperPrint print = JasperFillManager.fillReport("informes/informeEmail.jasper", parametros, jrds);
    ...
    public void imprimirCarpeta(ActionEvent event) {//informe para los correos de una carpeta
        ...
        if(listaEmail!=null) {
            ...
            try {
                JRBeanCollectionDataSource jrds = new JRBeanCollectionDataSource(listaEmail);
                Map<String, Object> parametros = new HashMap<>(); //En este caso no hay parámetros, aunque podría haberlos
                JasperPrint print = JasperFillManager.fillReport("informes/informeEmailsCarpeta.jasper", parametros, jrds);
                JasperExportManager.exportReportToPdfFile(print, file.toPath().toString());
    ...
    public void imprimirPorCarpetas(ActionEvent event) {
        ...
        if (listaEmails!=null) {
            try {
                ...
                Map<String, Object> parametros = new HashMap<>(); //En este caso no hay parámetros, aunque podría haberlos
                JasperPrint print = JasperFillManager.fillReport("informes/informeCorreosCuenta.jasper", parametros, jrds);
                JasperExportManager.exportReportToPdfFile(print, file.toPath().toString());
